...
class Personne {
    constructor(nom,lieu,argent,mainDroite,mainGauche){
        ...
        this.seDeplacer = (depart, destination) => {
            ...
            console.log(`${this.nom} est actuellement à la/l' ${this.lieu.nom}`);
        }
        ...
        this.acheter = (lieu) => {
            if (lieu.nom == "Epicerie") {
                ...
                console.log(`vous n'êtes pas à l'épicerie, vous ne pouvez pas prendre d'article`);
