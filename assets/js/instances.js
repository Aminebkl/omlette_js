...
// Personnes
let amine = new Personne('Amine',nullePart,200,[],[])
...
epicerie.ingredients = [oeuf,huile,poivre,lait,fromage]
...
export {maison,epicerie,amine,oeuf,huile,poivre,lait,fromage,bol,couteau,poele,nullePart}